...
const items = [
  ...
  { to: "/zones", label: "Zone Analytics", icon: ChartColumn },
  { to: "/settings", label: "Settings", icon: Settings }
];
function Sidebar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-60 shrink-0 border-r border-border bg-sidebar flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-14 flex items-center gap-2 px-4 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-sm bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-4 h-4 text-primary-foreground" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-sm tracking-tight", children: "AEROTRACK" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[9px] text-muted-foreground tracking-widest", children: "RFID OPS · v2.4" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 p-2 space-y-0.5", children: items.map(({ to, label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-t border-border font-mono text-[10px] text-muted-foreground space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "NODES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "14 / 14" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "UPLINK" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-success", children: "STABLE" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "LAT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "12ms" })
      ] })
    ] })
  ] });
}
function Topbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-14 border-b border-border bg-panel/80 backdrop-blur flex items-center px-4 gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-2xl relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded hover:bg-muted text-muted-foreground hover:text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-4 h-4" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 ml-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative p-2 rounded hover:bg-muted", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-4 h-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 w-4 h-4 rounded-full bg-destructive text-[10px] font-mono flex items-center justify-center text-destructive-foreground", children: "3" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-sm border border-border bg-background", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-dot bg-success animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "w-3.5 h-3.5 text-success" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] tracking-widest text-muted-foreground", children: "HANDHELD SYNC" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-sm bg-gradient-to-br from-primary to-success grid place-items-center text-primary-foreground font-mono text-xs font-bold", children: "MK" })
    ] })
  ] });
}
const appCss = "/assets/styles-K6xUe78W.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-muted-foreground tracking-widest mb-2", children: "ERR · 404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-6xl font-bold", children: "SIGNAL LOST" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "This route is off-grid. Return to the command center." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
        className: "mt-6 inline-flex items-center justify-center rounded-sm bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90",
...
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-semibold", children: "System fault detected" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: "mt-6 rounded-sm bg-primary px-4 py-2 text-sm font-medium text-primary-foreground",
        children: "Retry"
      }
    )
  ] }) });
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "AeroTrack — Aerospace Asset Intelligence" },
      { name: "description", content: "Real-time RFID asset tracking, digital twin, and lifecycle management for aircraft manufacturing and MRO operations." }
    ],
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Topbar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-6 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
    ] })
  ] }) });
}
const $$splitComponentImporter$4 = () => import("./zones-E4k_vjkr.js");
const Route$4 = createFileRoute("/zones")({
  head: () => ({
    meta: [{
      title: "Zone & Room Analytics — AeroTrack"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./settings-D0cjJqFJ.js");
const Route$3 = createFileRoute("/settings")({
  head: () => ({
    meta: [{
      title: "Settings — AeroTrack"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./lifecycle-COquFCZp.js");
const Route$2 = createFileRoute("/lifecycle")({
  head: () => ({
    meta: [{
      title: "Asset Lifecycle Manager — AeroTrack"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./digital-twin-Dk_5uEuj.js");
const Route$1 = createFileRoute("/digital-twin")({
  head: () => ({
    meta: [{
      title: "Digital Twin — AeroTrack"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CdRCJaf9.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "Command Center — AeroTrack"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ZonesRoute = Route$4.update({
  id: "/zones",
  path: "/zones",
...
const LifecycleRoute = Route$2.update({
  id: "/lifecycle",
  path: "/lifecycle",
  getParentRoute: () => Route$5
});
const DigitalTwinRoute = Route$1.update({
  id: "/digital-twin",
  path: "/digital-twin",
  getParentRoute: () => Route$5
});
